...
function AdminFileTree () {
    ...
    return (
        <OutsideAlerter func={() => setSelectedItem(null)} className="grow-1 flex flex-col ">
            <div className="flex gap-4 border-b border-custom px-4 justify-end py-2">
                <NewFile selectedItem={selectedItem} />
                <NewFolder selectedItem={selectedItem} />
            </div>
            <div className="grow-1 relative flex text-sm flex-col mx-5 ">
                {
                    tree && tree.length > 0
